...
export class Entry extends Serializable
	(input) ~>
		...
		if typeof! catchPhrase is 'String' => catchPhrase = {format: 'markdown', content: catchPhrase}
		...
		if typeof! description is 'String' => description = {format: 'markdown', content: description}
	...
	io:
		html:
			serialize: ->
				...
				catchPhrase = if catchPhrase.format is 'markdown'
					require! marked
					marked catchPhrase.content
				else
					catchPhrase.content

				description = if description.format is 'markdown'
					require! marked
					marked description.content
				else
					description.content
		...
		markdown:
			serialize: ->
				{name, category, catchPhrase, description, example} = @
